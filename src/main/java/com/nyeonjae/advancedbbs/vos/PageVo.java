...
public class PageVo {
    public final int countPerPage = 10;        // 한 페이지에 표시할 게시글의 갯수
    public final int requestPage;           // 클라이언트가 요청한 페이지 번호
    public final int totalCount;            // 전체 게시글의 갯수
    ...
    public final int offsetCount;           // 거르는 레코드 갯수

    // 위 상수를 결정하는데 필요한 변수는 requestPage 와 totalCount 두 개 임으로
